  ...
  const handleRegister = async () => {
    try {
      ...
      if (
        ...
        seterrorMessage(
          "a input field is empty! you need to fill all of them!"
        );
            ...
            <View style={styles["register-form"]}>
              <View style={styles["first-second"]}>
                <TextInput
                  ...
                  onChangeText={(val) =>
                    setuser_data((curr) => {
                      return { ...curr, first_name: val };
                    })
                  }
                  style={[styles["input-field"], styles["first-second"]]}
                />
                <TextInput
